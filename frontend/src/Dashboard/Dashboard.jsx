  ...
  return (
    <div>
      <Container>
        ...
        <Content>
          <Description>
            <h1>Welcome to Quip Study Rooms</h1>
            <p>
            Customizable virtual spaces where you can quiporate in real-time, share resources, and communicate with peers.
            </p>
            <ButtonContainer>
              <ActionButton
                onClick={() => {
